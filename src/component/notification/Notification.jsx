    ...
    <div>
      <section className="notificationSec pt80">
        <div className="container">
          {data.length > 0 ? (
            <div className="newClearBtn">
              <button
                className="mb-3 justify-content-end  btn btn_add_web text-white rounded"
                  ...
                  return (
                    <>
                      <div className="notificationParent">
                        ...
                        <i
                          className="fi fi-rr-rectangle-xmark text-danger  fs-2 mt-3"

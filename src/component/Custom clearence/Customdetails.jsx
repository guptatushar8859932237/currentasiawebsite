...
export default function CustomDetails() {
  ...
  const excludedKeys = ["Comment", "Dimension", "Hazardous"]; 
    ...
    useEffect(()=>{
      GetFreightImages()
       ...
       const GetFreightImages = () => {
        const data = { clearance_id:data1.id,uploaded_by:"2" };
      ...
      const deleteapi =(id) =>{
              ...
              axios.post(`${process.env.REACT_APP_BASE_URL}clearanceDocument`,data11).then((response)=>{
                GetFreightImages();

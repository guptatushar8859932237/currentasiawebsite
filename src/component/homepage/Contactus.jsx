    ...
    <div>
      ...
      <section>
        <div className="container my-5">
          <div className="row justify-content-center mt-5 align-items-center asiaContact">
            <div className="col-md-9">
              <div className="div1 mb-4">
                <h2 className="heading_1">Get in touch</h2>
              </div>
              <form onSubmit={postdata}>
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <label className="div_label">
                      Phone No <span className="redStar">*</span>
                    </label>
                    <input
                      type="text"
                      className="box1 form-control"
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <label className="div_label">
                      Nature of Enquiry <span className="redStar">*</span>
                    </label>
                    <select
                      name="enquiryType"
                      className="box1 form-control"
                  ...
                  <div className="col-md-6">
                    <label className="div_label">
                      Country / Office <span className="redStar">*</span>
                    </label>
                    <select
                      name="country"
                      className="box1 form-control"
            ...
            <div className="col-md-3">
              <div className="main3">
                ...
                >
                  <i className="fi fi-rr-marker icon1"></i>
                  <div>
                    <h6 className="call_heading">Address:</h6>
                    <p className="para1">Johannesburg, South Africa</p>
                  </div>
                </div>

                <div className="d-flex mb-3" style={{ cursor: "pointer" }}>
                  <i className="fi fi-rr-phone-call icon1"></i>
                  <div>
                    <h6 className="call_heading">Phone Number:</h6>
                    <a href="tel:+27104480733">
                      <p className="para1">+27 1044 80733</p>
                    </a>
                  </div>
                </div>
                ...
                <div
                  ...
                  onClick={openGmail}
                >
                  <i className="fi fi-rr-envelope icon1"></i>
                  <div>
                    <h6 className="call_heading">Email Address:</h6>
                    <p className="para1">sa@asiadirect.africa</p>
                  </div>
